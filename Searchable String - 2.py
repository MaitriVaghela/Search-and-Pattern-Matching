...
class SearchableStr:
    ...
    def searchString(self, target, ind=0,indx = -1):
        ...
        # Whichever functions output will be true, will return the answer as a whole True else False.
    ...
    def matchString(self, target,ind = -1):
        ...
        # It checks if the length of the string to be matched with is equal to its length
        # If it is, it returns False
        if len(self.searchedstring) == self.index:
            return False
        ...
        #  and also whether the rest characters matches
    ...
    def matchPat(self,target,index=-1):
        ...
        #It checks whther the length of the string to be matched with is 0 and also the target at self.ind is *
        ...
        #If the length of the string to be matched with is not 0,
        #then it slices the string to be matched with to its half
